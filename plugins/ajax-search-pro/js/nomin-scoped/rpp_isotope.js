...
/**
 * Modified to add to window.rpp_isotope
 */
...
if ( typeof define === 'function' && define.amd ) {
  ...
  // browser global
  window.rpp_isotope = window.rpp_isotope || {};
  window.rpp_isotope.Item = itemDefinition(
    window.Outlayer
  );
}
...
if ( typeof define === 'function' && define.amd ) {
  ...
  // browser global
  window.rpp_isotope = window.rpp_isotope || {};
  window.rpp_isotope.LayoutMode = layoutModeDefinition(
    window.getSize,
    window.Outlayer
  );
}
...
if ( typeof define === 'function' && define.amd ) {
  ...
  // browser global
  window.rpp_isotope = isotopeDefinition(
    window.Outlayer,
    window.getSize,
    window.matchesSelector,
    window.rpp_isotope.Item,
    window.rpp_isotope.LayoutMode
  );
}
