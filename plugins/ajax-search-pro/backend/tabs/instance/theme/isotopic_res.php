...
<div class="item">
    ...
    $o = new wpdreamsImageRadio("i_res_magnifierimage", "Hover background icon", array(
            'images'  => wpdreams_setval_or_getoption($sd, 'i_res_magnifierimage_selects', $_dk),
            'value'=> wpdreams_setval_or_getoption($sd, 'i_res_magnifierimage', $_dk)
        )
    );
    $params[$o->getName()] = $o->getData();
    ?>
...
<div class="item"><?php
    $o = new wpdreamsUpload("i_res_custom_magnifierimage", "Custom hover background icon", wpdreams_setval_or_getoption($sd, 'i_res_custom_magnifierimage', $_dk));
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item">
